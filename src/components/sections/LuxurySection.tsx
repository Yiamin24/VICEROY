...
export default function LuxurySection() {
  ...
  return (
    <section 
      ref={sectionRef}
      id="luxury" 
      className="py-20 md:py-32 lg:py-40 bg-background relative overflow-hidden"
    >
      <div className="max-w-[100rem] mx-auto px-6 md:px-12 lg:px-16">
        <div className="relative mb-20 md:mb-32">
          {/* Main Text - Two Lines as in Reference */}
          <h2 
            className="font-heading text-foreground text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-light tracking-tight"
          >
          ...
          <button
            ...
            className="absolute -bottom-16 right-0 md:-bottom-20 md:right-8 lg:right-16 w-12 h-12 md:w-14 md:h-14 bg-foreground rounded-full flex items-center justify-center hover:bg-foreground/80 transition-colors"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            {/* Text Content */}
            <p 
              className="font-paragraph text-foreground text-base md:text-lg leading-relaxed"
            >
